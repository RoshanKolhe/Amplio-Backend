...
>(DefaultCrudRepository) {
  ...
  constructor(
    ...
    @repository.getter('InvestorPanCardsRepository') protected investorPanCardsRepositoryGetter: Getter<InvestorPanCardsRepository>,
    @repository.getter('UsersRepository') protected usersRepositoryGetter: Getter<UsersRepository>,
    @repository.getter('KycApplicationsRepository') protected kycApplicationsRepositoryGetter: Getter<KycApplicationsRepository>,
    @repository.getter('InvestorTypeRepository') protected investorTypeRepositoryGetter: Getter<InvestorTypeRepository>,
  ) {
